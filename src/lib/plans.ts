...
export const PLAN_TOOLS: Record<Plan, string[]> = {
  FREE: ['analyse'],
  PRO: ['analyse', 'eeat', 'rewrite', 'backlinks', 'citation', 'gap', 'queries', 'fixer'],
  AGENCY: ['analyse', 'eeat', 'rewrite', 'backlinks', 'citation', 'gap', 'queries', 'tracker', 'local', 'serp', 'topical', 'fixer'],
}
